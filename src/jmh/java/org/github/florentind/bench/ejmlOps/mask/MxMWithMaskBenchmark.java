...
public class MxMWithMaskBenchmark extends MatrixOpsBaseBenchmark {
    ...
    public void mxmTWithMask(Blackhole bh) {
        bh.consume(CommonOpsWithSemiRing_DSCC.multTransB(matrix, matrix, null, DSemiRings.AND_OR, mask, null, null, null));
    }

    @Benchmark
    public void mxmT(Blackhole bh) {
        bh.consume(CommonOpsWithSemiRing_DSCC.multTransB(matrix, matrix, null, DSemiRings.AND_OR, null, null, null, null));
    }
}

...
public class BfsParentNativeBenchmark extends BfsNativeBenchmark {
    @Override
    protected void benchmarkFunc(Integer concurrency) {
        new BfsNative().computeParent(jniMatrix, startNode, MAX_ITERATIONS, concurrency);
    }

    public static void main(String[] args) {
        new BfsParentNativeBenchmark().run();
    }
}
